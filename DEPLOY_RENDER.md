...
Essas credenciais ficam apenas no servidor. Nao use prefixo `VITE_` para Merchant ID, Merchant Key ou secrets da Cielo.
...
4. Configure as variaveis `CIELO_MERCHANT_ID`, `CIELO_MERCHANT_KEY`, `CIELO_3DS_CLIENT_ID`, `CIELO_3DS_CLIENT_SECRET`, `CIELO_ENV` e `SITE_URL`.
5. Faça o deploy.
